...
If _Return = -1 Then
	MessageBox('Não foi possível conectar-se com o servidor.', 16, 'Erro conexão!')
	Do Form login
Else
	Try
		Select cEmail
		...
		EndScan
	Catch To oErr
		MessageBox('Não foi possível inserir a base de emails na tabela email,' + Chr(13) + 'por favor verifique possível problema na tabela email.', 16, 'Erro tabela!')
	EndTry
	Do Form send
EndIf
